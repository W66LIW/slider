...
export default function Bottle() {
    return (
        <div style={{position:"absolute", bottom:"-40px", left:"60px"}}>
            ...
            <img src={b2} alt="bubble" style={{position:"absolute", zIndex:"1", width:"135px", top:"230px", right:"-50px", opacity:"0.929"}} className="Anim"/>
            ...
            <img src={b6} alt="bubble" style={{position:"absolute", zIndex:"2", width:"170px", bottom:"-60px", right:"-60px", opacity:"0.929"}} className="AnimV"/>
        </div>
    )
}